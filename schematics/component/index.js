...
function default_1(options) {
    ...
    return function (host, context) {
        ...
        var templateSource = schematics_1.apply(schematics_1.url('./files'), [
            options.spec ? schematics_1.noop() : schematics_1.filter(function (path) { return !path.endsWith('.spec.ts'); }),
            options.inlineStyle ? schematics_1.filter(function (path) { return !path.endsWith('.__styleext__'); }) : schematics_1.noop(),
            options.inlineTemplate ? schematics_1.filter(function (path) { return !path.endsWith('.html'); }) : schematics_1.noop(),
            schematics_1.template(__assign({}, stringUtils, { 'if-flat': function (s) { return options.flat ? '' : s; } }, options)),
